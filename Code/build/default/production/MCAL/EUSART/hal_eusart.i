...
# 2 "<built-in>" 2
# 1 "MCAL/EUSART/hal_eusart.c" 2
# 1 "MCAL/EUSART/hal_eusart.h" 1
# 12 "MCAL/EUSART/hal_eusart.h"
# 1 "MCAL/EUSART/../GPIO/hal_gpio.h" 1
# 16 "MCAL/EUSART/../GPIO/hal_gpio.h"
...
# 16 "MCAL/EUSART/../GPIO/hal_gpio.h" 2

# 1 "MCAL/EUSART/../GPIO/../mcal_std_types.h" 1
# 17 "MCAL/EUSART/../GPIO/../mcal_std_types.h"
# 1 "MCAL/EUSART/../GPIO/../config.h" 1
...
# 17 "MCAL/EUSART/../GPIO/../mcal_std_types.h" 2
...
# 17 "MCAL/EUSART/../GPIO/hal_gpio.h" 2
# 36 "MCAL/EUSART/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_PORTA,
    GPIO_PORTB,
    GPIO_PORTC,
...
# 12 "MCAL/EUSART/hal_eusart.h" 2

# 1 "MCAL/EUSART/../../MCAL/INTERRUPT/internal_interrupt.h" 1
# 19 "MCAL/EUSART/../../MCAL/INTERRUPT/internal_interrupt.h"
# 1 "MCAL/EUSART/../../MCAL/INTERRUPT/manage_interrupt.h" 1
# 17 "MCAL/EUSART/../../MCAL/INTERRUPT/manage_interrupt.h"
# 1 "MCAL/EUSART/../../MCAL/INTERRUPT/interrupt_config.h" 1
# 17 "MCAL/EUSART/../../MCAL/INTERRUPT/interrupt_config.h"
# 1 "MCAL/EUSART/../../MCAL/INTERRUPT/interrupt_gen_cfg.h" 1
# 17 "MCAL/EUSART/../../MCAL/INTERRUPT/interrupt_config.h" 2
# 51 "MCAL/EUSART/../../MCAL/INTERRUPT/interrupt_config.h"
typedef enum{
    LOW_PRIORITY = 0,
    HIGH_PRIORITY
}interrupt_priority;
# 17 "MCAL/EUSART/../../MCAL/INTERRUPT/manage_interrupt.h" 2



void ISR_TX_EUSART(void);
void ISR_RX_EUSART(void);
# 19 "MCAL/EUSART/../../MCAL/INTERRUPT/internal_interrupt.h" 2
# 13 "MCAL/EUSART/hal_eusart.h" 2
# 65 "MCAL/EUSART/hal_eusart.h"
typedef union{
    struct{
        uint8 reseved:6;
...
static void Eusart_Async_Rx_Init(const eusart_t *eusart);
    ...
    static void (*EUSART_FraminErrorInterruptHandler)(void) = ((void*)0);
    static void (*EUSART_OverrunErrorInterruptHandler)(void) = ((void*)0);
...
Std_ReturnType EUSART_Async_WriteStringNonBlocking(uint8 *data, uint16 lenStr){
    ...
    if(current_index < lenStr){
        if(EUSART_Async_WriteCharNonBlocking(data[current_index]) == (Std_ReturnType)1){
            current_index++;
        }
    }
    else{
...
static void Eusart_Async_Calc_BaudRate(const eusart_t *eusart){
    ...
    switch(eusart->baud_rate_config){
        case ASYNC_8BIT_LOW:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 0;
            baudRate_formula = ((8000000UL / (float)eusart->baudrate) / 64) - 1;
            break;
        ...
        case ASYNC_8BIT_HIGH:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            baudRate_formula = ((8000000UL / (float)eusart->baudrate) / 16) - 1;
            break;
        ...
        case ASYNC_16BIT_HIGH:
            ...
            BAUDCONbits.BRG16 = 1;
            TXSTAbits.BRGH = 1;
            baudRate_formula = ((8000000UL / (float)eusart->baudrate) / 4) - 1;
            break;
...
static void Eusart_Async_Tx_Init(const eusart_t *eusart){
    if(1 == eusart->tx.transmit_enable){
        TXSTAbits.TXEN = 1;

        if(1 == eusart->tx.transmit_interrupt_enable){

                (PIE1bits.TXIE = 1);
                EUSART_TXInterruptHandler = eusart->EUSART_TXDefaultInterruptHandler;
# 191 "MCAL/EUSART/hal_eusart.c"
                    (INTCONbits.GIE = 1);
                    (INTCONbits.PEIE = 1);


        }
        else if(0 == eusart->tx.transmit_interrupt_enable){
            (PIE1bits.TXIE = 0);
        }
        else{
        ...
        if(1 == eusart->tx.select_9bit_transmit){
            TXSTAbits.TX9 = 1;
        }
        else if(0 == eusart->tx.select_9bit_transmit){
            TXSTAbits.TX9 = 0;
        }
        else{
    ...
    else if(0 == eusart->tx.transmit_enable){
        TXSTAbits.TXEN = 0;
    }
    else{
...
static void Eusart_Async_Rx_Init(const eusart_t *eusart){
    if(1 == eusart->rx.receive_enable){
        RCSTAbits.CREN = 1;

        if(1 == eusart->rx.receive_interrupt_enable){
...
# 244 "MCAL/EUSART/hal_eusart.c"
                    (INTCONbits.GIE = 1);
                    (INTCONbits.PEIE = 1);


        }
        else if(0 == eusart->rx.receive_interrupt_enable){
            (PIE1bits.RCIE = 0);
        }
        else{
        ...
        if(1 == eusart->rx.select_9bit_receive){
            RCSTAbits.RX9 = 1;
        }
        else if(0 == eusart->rx.select_9bit_receive){
            RCSTAbits.RX9 = 0;
        }
        else{
    ...
    else if(0 == eusart->rx.receive_enable){
        RCSTAbits.CREN = 0;
    }
    else{
