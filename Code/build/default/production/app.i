...
# 17 "./MCAL/EUSART/../GPIO/hal_gpio.h"
...
eusart_t eusart_obj = {
    ...
    .tx.transmit_enable = 1,
    .tx.transmit_interrupt_enable = 1,
    .tx.select_9bit_transmit = 0,

    .rx.receive_enable = 1,
    .rx.receive_interrupt_enable = 1,
    .rx.select_9bit_receive = 0,


    .EUSART_FraminErrorInterruptHandler = ((void*)0),
    .EUSART_OverrunErrorInterruptHandler = ((void*)0),
